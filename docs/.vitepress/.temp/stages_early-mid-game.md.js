...
const __pageData = JSON.parse('{"title":"Early Mid Game","description":"","frontmatter":{},"headers":[],"relativePath":"stages/early-mid-game.md","filePath":"stages/early-mid-game.md"}');
const _sfc_main = { name: "stages/early-mid-game.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("stages/early-mid-game.md");
