...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Skyblock Guide/Wiki by Fury","description":"A Progression guide/wiki for Fakepixel Skyblock","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Guide","link":"/main"},{"text":"Contact","link":"/contacts"}],"sidebar":{"/stages/":[{"text":"Progression Stages","items":[{"text":"Early Game","link":"/stages/early-game"},{"text":"Early-Mid Game","link":"/stages/early-mid-game"},{"text":"Mid Game","link":"/stages/mid-game"},{"text":"Mid-Late Game","link":"/stages/mid-late-game"},{"text":"Late Game","link":"/stages/late-game"},{"text":"End Game","link":"/stages/end-game"}]}],"/skills/":[{"text":"Skill Guides","items":[{"text":"Combat","link":"/skills/Combat"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/UnTamed-Fury/phub"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
